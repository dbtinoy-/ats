...
## Recommendations
I recommend that you use Grunt to compile and minify your assets. See this [article](http://job.elenakolevska.com/using-grunt-with-laravel-and-bootstrap) for details.
