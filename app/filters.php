...
Entrust::routeNeedsPermission('admin/job-posts*', 'manage_jobs', Redirect::to('/admin'));
Entrust::routeNeedsPermission('admin/cvs*', 'manage_cvs', Redirect::to('/admin'));
...
// Check for role on all recruitment routes
Entrust::routeNeedsRole('recruitment', array('recruiter'), Redirect::to('/'));
