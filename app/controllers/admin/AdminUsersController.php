        ...
        return Datatables::of($users)
                        ...
                        ->add_column(
                            ...
                            <ul class="dropdown-menu" role="menu" aria-labelledby="dropdownMenu1">
                              <li role="presentation"><a role="menuitem" tabindex="-1" class="iframe" href="{{{ URL::to(\'admin/users/\' . $id . \'/edit\' ) }}}"><span class=\'glyphicon glyphicon-edit\'></span> {{{ Lang::get(\'button.edit\') }}}</a></li>
                                @if($username == \'admin\')
                                @else
                              <li role="presentation"><a role="menuitem" tabindex="-1" class="iframe-small" href="{{{ URL::to(\'admin/users/\' . $id . \'/delete\' ) }}}"><span class=\'glyphicon glyphicon-minus\'></span> {{{ Lang::get(\'button.delete\') }}}</a></li>
                              @endif
                            </ul>
                          </div>')
                        ->remove_column('id')
