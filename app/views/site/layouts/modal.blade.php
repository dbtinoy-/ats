...
<html lang="en">
    ...
    <body>
        <div class="pull-right" style="position:absolute;top:5px;right:5px">
            <button class="btn btn-danger btn-xs btn-inverse close_popup">X</button>
        </div>
        <div class="container" style="max-height:90%;overflow-y: auto;position:absolute;top:30px;bottom:40px;width:100%">
