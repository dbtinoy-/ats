                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse navbar-ex1-collapse">
                        <ul class="nav navbar-nav">
                            <li{{ (Request::is('admin') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin') }}}"><img style="margin-top:-15px;margin-bottom:-15px" src="{{ asset('assets/img/logo.png') }}" /></a></li>
                            <li{{ (Request::is('admin/job-posts*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/job-posts') }}}"><span class="glyphicon glyphicon-list-alt"></span> Job Posts</a></li>
                            <li{{ (Request::is('admin/cvs*') ? ' class="active"' : '') }}><a href="{{{ URL::to('admin/cvs') }}}"><span class="glyphicon glyphicon-asterisk"></span> CVs</a></li>
