...
@section('content')
	...
	<table id="roles" class="table table-striped table-hover">
		<thead>
			<tr>
				<th class="col-xs-6">{{{ Lang::get('admin/roles/table.name') }}}</th>
				<th class="col-xs-2">{{{ Lang::get('admin/roles/table.users') }}}</th>
				<th class="col-xs-2">{{{ Lang::get('admin/roles/table.created_at') }}}</th>
