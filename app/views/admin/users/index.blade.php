...
<table id="users" class="table table-striped table-hover">
    <thead>
        <tr>
            ...
            <th class="col-xs-2">{{{ Lang::get('admin/users/table.email') }}}</th>
            <th class="col-xs-2">{{{ Lang::get('admin/users/table.roles') }}}</th>
            <th class="col-xs-2">{{{ Lang::get('admin/users/table.activated') }}}</th>
            <th class="col-xs-2">{{{ Lang::get('admin/users/table.created_at') }}}</th>
